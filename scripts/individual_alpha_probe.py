...
DEFAULT_INDICATOR_CACHE_PATH = DEFAULT_DATA_ROOT / "indicator_cache" / "daily_indicators.parquet"
DEFAULT_MARKET_CACHE_DIR = DEFAULT_DATA_ROOT / "market_cache" / "daily_bars_by_symbol"
DEFAULT_POOLS_DIR = DEFAULT_DATA_ROOT / "pools"
DEFAULT_OUTPUT_DIR = DEFAULT_DATA_ROOT / "output" / "individual_alpha_probe"
